...
// Helper functions to render icons and colors
...
const SimpleCommunicationItem = ({ communication }: { communication: any }) => (
  <div className="p-4 border rounded-lg mb-3 hover:border-[#275E91] hover:shadow-sm transition-all duration-200 cursor-pointer bg-white">
    <div className="flex items-start gap-3">
      ...
      <div className="flex-1">
        <div className="flex items-center mb-1 gap-2">
          <Badge className={cn("text-xs font-medium", getTypeColor(communication.type))}>
            {communication.type.charAt(0).toUpperCase() + communication.type.slice(1)}
          </Badge>
          <Badge className={cn("text-xs font-medium", getSentimentColor(communication.sentiment))}>
...
const ImprovedRelationshipsDashboard: React.FC = () => {
  return (
    <div className="space-y-6">
      ...
      {/* Investor Communications Log Section */}
      <Card className="shadow-sm">
        <CardHeader className="pb-3">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button className="h-8 bg-[#275E91] hover:bg-[#1E4A73] text-white" size="sm">
        ...
        <CardContent>
          <div className="flex gap-2 mb-4 flex-wrap">
            <Button variant="outline" size="sm" className="text-xs bg-[#275E91] text-white hover:bg-[#1E4A73]">All Communications</Button>
      ...
      {/* Investor Engagement Analytics Section */}
      <SimpleEngagementMetrics />
    </div>
  );
};

export default ImprovedRelationshipsDashboard;